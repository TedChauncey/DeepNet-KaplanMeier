...
Outcomes_file = '/home/chintan/Desktop/tsne_python/Stage1/TestO_RightCensored.csv' #define the outcomes file, sorted according to PID
path1 = '/home/chintan/Desktop/tsne_python/Stage1/Stage1Test' #change this to only test images    
...
Stage = pd.Series.as_matrix(Outcomes.loc[:,'STAGEITYPE'])
