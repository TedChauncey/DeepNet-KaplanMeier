...
img_channels = 1
# data
Outcomes_file = '/home/chintan/Desktop/tsne_python/Stage1/Stage1and2Test.csv' #define the outcomes file, sorted according to PID
#Outcomes_file = '/home/chintan/Desktop/Histology/AllOutcomes.csv'

#path1 = '/home/chintan/Desktop/Histology/ALLImages'

path1 = '/home/chintan/Desktop/tsne_python/Stage1/Stage1and2Test' #change this to only test images    
...
E = pd.Series.as_matrix(Outcomes.loc[:,'SURV2'])
g = Y_pred[:,1]
g[g>=median(g)] = 1
g[g<median(g)] = 0
...
plt.title('Kaplan-Meier estimate by Neural Network Stratification')
