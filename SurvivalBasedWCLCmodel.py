### This model is to predict histology in Stage Iand II NSCLC using pretrained VGG-16###
### Tafadzwa L. Chaunzwa 7-2-18 ###
...
model_top = Dropout(0.25)(model_top) #set to 0.5
model_top =Dense(4096, activation = 'relu')(model_top)
model_top = Dropout(0.25)(model_top) #set to 0.5
...
for layer in model.layers[:3]:  # 3 is original mode. Layer 11 has best performance? 15 or 11 or 6 or 3  
...
Outcomes_file = '/home/chintan/Desktop/WCLC/Stage1and2Train_FollowUps.csv' #define the outcomes file, sorted according to PID
...
input_image=X_train[im_index,:,:,:].reshape(1,img_rows, img_cols,3)
plt.figure(3)
