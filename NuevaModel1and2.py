...
model_top =Dense(4096, activation = 'relu')(model_top)
#model_top = Dropout(0.2)(model_top)
#model_top =Dense(1000, activation = 'relu')(model_top)
#model_top = Dropout(0.5)(model_top)
#model_top =Dense(2, activation = 'relu')(model_top)
model_top = Dropout(0.2)(model_top)
...
Outcomes_file = '/home/chintan/Desktop/tsne_python/Stage1/Stage1and2Train.csv' #define the outcomes file, sorted according to PID
path1 = '/home/chintan/Desktop/tsne_python/Stage1/Stage1and2Train'    #path of folder of images    
